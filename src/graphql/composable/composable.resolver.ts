...
/**
 * @description TSource é equivalente ao parent, e TContext ao context que são paramentros do resolver
 * basicamente tipamos esses caras.
 */
export type ComposableResolver<TSource, TContext> = 
    /**
     * @param {function} fn - recebe um GraphQLFieldResolver que vai executar nossa logica 
     * e retornando um resolver.
     */
